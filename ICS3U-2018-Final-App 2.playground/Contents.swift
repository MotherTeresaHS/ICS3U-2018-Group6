...
class GameScene : SKScene, SKPhysicsContactDelegate {
    ...
    func spawnEnemy() {
        ...
        aSingleEnemy.position = CGPoint(x: enemyStartPostitionX, y: Int(frame.midY))
        aSingleEnemy.setScale(0.25)
        aSingleEnemy.zPosition = 7.0
        let enemyMove = SKAction.move(to: CGPoint(x: frame.midX, y: frame.midY), duration: TimeInterval(5 - (enemySpeedRate / 4)))
        ...
        aSingleEnemy.physicsBody?.contactTestBitMask = collisionBulletCategory | collisionEnemyCategory
