...
class GameScene : SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        let animateNinja = SKAction.repeatForever(SKAction.animate(with: ninjaIdleArray, timePerFrame: 0.1))
        ninja.run(animateNinja)
    }
